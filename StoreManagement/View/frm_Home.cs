...
//using ListView = System.Windows.Forms.VisualStyles.VisualStyleElement.ListView;
        ...
        private void TreeView1_TabIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Database.Products.Where(x => x.Name == node.Text).Count() > 0)
            {
               ...
               // listView1.Columns.Add("quantity") ;
                //listView1.Columns[nameof(data.ID)].Width = 
                ...
                //lvi.SubItems.Add(data.quantity.ToString());
